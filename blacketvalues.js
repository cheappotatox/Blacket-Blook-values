const blookValues = [
    ...
    { name: 'Golden Gift', copies: 220, value: calculateNewValue(350, 220, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 350, rarity: "Chroma", droprate: '0.01%', glicko: calculateGlicko(220, 0.01, 72.5, 27.9675, 25), demand: calculateDemand(220)},
    { name: 'Nutcracker Koala', copies: 47, value: calculateNewValue(350, 47, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 350 , rarity: "Chroma", droprate: '0.01%', glicko: calculateGlicko(47, 0.01, 72.5, 27.9675, 25), demand: calculateDemand(47)},
    { name: 'Elf Sweater Snowman', copies: 64, value: calculateNewValue(350, 64, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 350, rarity: "Chroma", droprate: '0.01%', glicko: calculateGlicko(64, 0.01, 72.5, 27.9675, 25), demand: calculateDemand(64)},
    { name: 'Blue Sweater Snowman', copies: 110, value: calculateNewValue(300, 110, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(110, 0.02, 72.5, 27.9675, 25), demand: calculateDemand(110)},
    { name: 'Red Sweater Snowman', copies: 131, value: calculateNewValue(300, 131, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(131, 0.02, 72.5, 27.9675, 25), demand: calculateDemand(131)},
    { name: 'Snowy Bush Monster', copies: 79, value: calculateNewValue(300, 79, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(79, 0.02, 72.5, 27.9675, 25), demand: calculateDemand(79)},
    { name: 'Chilly Flamingo', copies: 123, value: calculateNewValue(300, 123, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.03%', glicko: calculateGlicko(123, 0.03, 72.5, 27.9675, 25), demand: calculateDemand(123)},
    { name: 'Tropical Globe', copies: 406, value: calculateNewValue(300, 406, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(406, 0.02, 72.5, 27.9675, 25), demand: calculateDemand(406)},
    { name: 'Cookies Combo', copies: 192, value: calculateNewValue(300, 192, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.03%', glicko: calculateGlicko(192, 0.03, 72.5, 27.9675, 25), demand: calculateDemand(192)},
    { name: 'Frost Wreath', copies: 553, value: calculateNewValue(300, 553, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.03%', glicko: calculateGlicko(553, 0.03, 72.5, 27.9675, 25), demand: calculateDemand(553)},
    { name: 'Paris Snow Globe', copies: 905, value: calculateNewValue(300, 905, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(905, 0.05, 72.5, 27.9675, 25), demand: calculateDemand(905)},
    { name: 'Egypt Snow Globe', copies: 832, value: calculateNewValue(300, 832, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(832, 0.05, 72.5, 27.9675, 25), demand: calculateDemand(832)},
    { name: 'Japan Snow Globe', copies: 871, value: calculateNewValue(300, 871, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(871, 0.05, 72.5, 27.9675, 25), demand: calculateDemand(871)},
    { name: 'London Snow Globe', copies: 902, value: calculateNewValue(300, 902, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(902, 0.05, 72.5, 27.9675, 25), demand: calculateDemand(902)},
    { name: 'New York Snow Globe', copies: 926, value: calculateNewValue(300, 926, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(926, 0.05, 72.5, 27.9675, 25), demand: calculateDemand(926)},
    { name: 'Santa Claws', copies: 242, value: calculateNewValue(300, 242, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(242, 0.05, 72.5, 27.9675, 25), demand: calculateDemand(242)},
