const blookValues = [
    ...
    { name: 'Hamsta Claus', copies: 5, value: calculateNewValue(1000, 5, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 1000, rarity: "Mystical", glicko: calculateGlicko(5, 1000)},
    { name: 'Diamond Gift', copies: 160, value: calculateNewValue(1000, 160, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 1000, rarity: "Mystical", glicko: calculateGlicko(160, 1000) },
    ...
    { name: 'Golden Gift', copies: 204, value: calculateNewValue(350, 204, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 350, rarity: "Chroma", glicko: calculateGlicko(204, 350)},
    { name: 'Nutcracker Koala', copies: 31, value: calculateNewValue(350, 31, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 350 , rarity: "Chroma", glicko: calculateGlicko(31, 350)},
    { name: 'Elf Sweater Snowman', copies: 49, value: calculateNewValue(350, 49, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 350, rarity: "Chroma", glicko: calculateGlicko(49, 350)},
    { name: 'Blue Sweater Snowman', copies: 80, value: calculateNewValue(300, 80, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(80, 300)},
    { name: 'Red Sweater Snowman', copies: 94, value: calculateNewValue(300, 94, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(95, 300)},
    { name: 'Snowy Bush Monster', copies: 41, value: calculateNewValue(300, 41, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(41, 300)},
    { name: 'Chilly Flamingo', copies: 84, value: calculateNewValue(300, 84, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(84, 300)},
    { name: 'Tropical Globe', copies: 381, value: calculateNewValue(300, 381, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(381, 300)},
    { name: 'Cookies Combo', copies: 116, value: calculateNewValue(300, 116, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(116, 300)},
    { name: 'Frost Wreath', copies: 516, value: calculateNewValue(300, 516, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", glicko: calculateGlicko(516, 300)},
    { name: 'Paris Snow Globe', copies: 847, value: calculateNewValue(300, 847, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", glicko: calculateGlicko(847, 300)},
    { name: 'Egypt Snow Globe', copies: 769, value: calculateNewValue(300, 769, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", glicko: calculateGlicko(769, 300)},
    { name: 'Japan Snow Globe', copies: 791, value: calculateNewValue(300, 791, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(791, 300)},
    { name: 'London Snow Globe', copies: 825, value: calculateNewValue(300, 825, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", glicko: calculateGlicko(825, 300)},
    { name: 'New York Snow Globe', copies: 857, value: calculateNewValue(300, 857, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", glicko: calculateGlicko(857, 300)},
    { name: 'Santa Claws', copies: 150, value: calculateNewValue(300, 150, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", glicko: calculateGlicko(150, 300)},
