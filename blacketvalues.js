const blookValues = [
    ...
    { name: 'Blue Sweater Snowman', copies: 135, value: calculateNewValue(300, 135, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(135, 0.02, 72.5, 27.9675, 25), demand: "Moderate"},
    { name: 'Red Sweater Snowman', copies: 149, value: calculateNewValue(300, 149, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(149, 0.02, 72.5, 27.9675, 25), demand: "Low"},
    { name: 'Snowy Bush Monster', copies: 94, value: calculateNewValue(300, 94, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(94, 0.02, 72.5, 27.9675, 25), demand: "Moderate"},
    ...
    { name: 'Tropical Globe', copies: 425, value: calculateNewValue(300, 425, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.02%', glicko: calculateGlicko(425, 0.02, 72.5, 27.9675, 25), demand: "Low"},
    ...
    { name: 'Paris Snow Globe', copies: 926, value: calculateNewValue(300, 926, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(926, 0.05, 72.5, 27.9675, 25), demand: "Low"},
    { name: 'Egypt Snow Globe', copies: 862, value: calculateNewValue(300, 862, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(862, 0.05, 72.5, 27.9675, 25), demand: "Low"},
    { name: 'Japan Snow Globe', copies: 901, value: calculateNewValue(300, 901, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(901, 0.05, 72.5, 27.9675, 25), demand: "Low"},
    { name: 'London Snow Globe', copies: 939, value: calculateNewValue(300, 939, 25, 72.5, 27.9675), pack: 'Blizzard Pack', sellprice: 300 , rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(939, 0.05, 72.5, 27.9675, 25), demand: "Low"},
    { name: 'New York Snow Globe', copies: 956, value: calculateNewValue(300, 956, 25, 72.5, 27.9675), pack: 'Blizzard Pack' , sellprice: 300, rarity: "Chroma", droprate: '0.05%', glicko: calculateGlicko(956, 0.05, 72.5, 27.9675, 25), demand: "Low"},
